...
Revision ID: 3b1f051dcb67
Revises: 
Create Date: 2025-08-31 10:58:12.868608
...
def upgrade():
    ...
    sa.Column('appointments_set', sa.Integer(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('annual_income_goal', sa.Float(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
